...
interface NationOperationFactory {
    ...
    fun buildSetMember(nation: Nation, commander: NationMember, uniqueId: UUID, rank: NationRank): NationOperation<Boolean>
    ...
    fun buildChangeMetadata(nation: Nation, commander: NationMember, key: String, value: String): NationOperation<Boolean>
