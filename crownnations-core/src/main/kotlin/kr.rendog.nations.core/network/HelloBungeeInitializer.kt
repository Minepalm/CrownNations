...
import kr.rendog.nations.core.NationAdmins
import kr.rendog.nations.core.RendogNations
...
object HelloBungeeInitializer{
    ...
    fun apply(network : PalmNetwork, service : NationService){
        ...
        network.handler.apply {
            ...
            registerExecutor(NationAdmins.UpdateSignal.Executor((service as RendogNations).admins))
        }
    }
}