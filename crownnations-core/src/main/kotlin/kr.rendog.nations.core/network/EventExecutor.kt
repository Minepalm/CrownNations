...
sealed class EventExecutor {
    ...
    ) : HelloExecutor<NationAddMemberEvent> {

        override val identifier: String = NationAddMemberEvent::class.java.simpleName

        override fun executeReceived(event : NationAddMemberEvent) {
