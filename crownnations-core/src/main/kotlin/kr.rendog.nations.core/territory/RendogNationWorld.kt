...
import kr.rendog.nations.territory.NationWorld
...
class RendogNationWorld(
    ...
    override val remote: NationWorld.Remote = RemoteImpl(server.name, name, database, factory)
    ...
    class LocalImpl(
        ...
        override fun getMonuments(): List<NationMonument> {
            return localMap.values.let { mutableListOf<NationMonument>().apply { addAll(it) } }
        }
