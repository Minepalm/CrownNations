...
import kr.rendog.nations.territory.NationWorldUniverse
import kr.rendog.nations.utils.ServerLoc
import java.util.concurrent.CompletableFuture
import java.util.concurrent.ConcurrentHashMap
import java.util.concurrent.TimeUnit

class RendogNationWorldUniverse(
    ...
    class WorldFactory(
        ...
        fun build(server: String, name: String): NationWorld?{
            ...
            return nationServer?.let { RendogNationWorld(it, name, isLocal, service, database, factory) }
        }
